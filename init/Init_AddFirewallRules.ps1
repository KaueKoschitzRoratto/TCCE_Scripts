...
$existingRule = Get-NetFirewallRule -DisplayName "Tcce_Mqtt"
...
$existingRule = Get-NetFirewallRule -DisplayName "Tcce_TcOpcUaGateway"
if ($existingRule -eq $null) {
...
$existingRule = Get-NetFirewallRule -DisplayName "Tcce_TcHmi"
if ($existingRule -eq $null) {
...
$existingRule = Get-NetFirewallRule -DisplayName "Tcce_Agent"
if ($existingRule -eq $null) {
...
$existingRule = Get-NetFirewallRule -DisplayName "Tcce_AdsDiscovery"
if ($existingRule -eq $null) {
...
$existingRule = Get-NetFirewallRule -DisplayName "Tcce_AdsSecure"
if ($existingRule -eq $null) {
