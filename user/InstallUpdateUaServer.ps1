...
$repoUrl = "https://github.com/SvenGoldstein/Tcce_UaServer"
$repoUrlApi = "https://api.github.com/repos/SvenGoldstein/Tcce_UaServer"
$releaseBinaryName = "TcCloudEngineeringUaServer.zip"
